...
/* Modify the poker.c program of section 10.5 by moving all external variables into main and modifying functions so that
 * they communicate by passing arguments. The analayze_hand function needs to change the straight, flush, four, three,
